package com.zhengcheng.kaptcha;
...
public class KaptchaAutoConfiguration {
    ...
    public DefaultKaptcha getKaptchaBeanMath() {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.zhengcheng.kaptcha.text.impl.KaptchaTextCreator");
        // 验证码文本字符间距 默认为2
